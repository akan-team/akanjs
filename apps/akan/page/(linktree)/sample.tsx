        ...
        <div className="grid flex-1 items-center gap-10 py-16 lg:grid-cols-[1.04fr_0.96fr] lg:py-10">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <span className="badge badge-lg border-foreground/10 bg-foreground/10 text-foreground">Agent-ready</span>
              <span className="badge badge-lg border-foreground/10 bg-foreground/10 text-foreground">Minimal code</span>
