...
const menuItemVariants = cva(
  cn(
    "relative flex h-9 cursor-pointer select-none items-center rounded-xs px-2 py-1.5 text-sm outline-hidden transition-colors",
...
>(({ className, children, hideIcon, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ref={ref}
    className={cn(
      "relative flex select-none items-center rounded-xs pl-8 pr-2 text-sm outline-hidden transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
